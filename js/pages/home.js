...
const HomePage = (() => {
    ...
    return `
      <div class="product-card" data-id="${p.id}">
        <a href="product-detail.html?id=${p.id}" class="product-card-img">
          ...
          ${imgSrc !== "assets/images/placeholder.svg" ? `<img src="${imgSrc}" alt="${escapeHtml(p.name)}" onerror="this.src='assets/images/placeholder.svg'" loading="lazy" />` : `<span>${p.emoji || "📦"}</span>`}
  ...
  function toggleWishlist(productId) {
    ...
    // Refresh all product cards to update wishlist button state
    renderFeatured();
    renderNewArrivals();
