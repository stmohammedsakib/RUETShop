  ...
  function _seedUsers() {
    const users = [
      // ── Admins ──
      {
        ...
        email: "ashrafulanower@ruet.ac.bd",
        password: btoa("admin12345_ruet_salt"),
        role: "admin",
        phone: "+8801816442249",
        address: "Department of ECE, RUET",
        avatar: "",
      ...
      },
      {
        id: "admin_003",
        name: "Mohammed Sakib",
        email: "mohammedsakib@ruet.ac.bd",
        password: btoa("admin12345_ruet_salt"),
        role: "admin",
        phone: "+8801310097126",
        address: "Department of ECE, RUET",
